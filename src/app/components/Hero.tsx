...
export default function Hero(){
    ...
    return(
        <div className= "flex flex-col ml-[60px]  w-[240px] md:w-[300px] lg:w-[360px]" >
            ...
            <hr className = "border-3"/>
            <p className = "py-[60px] w-[180px] lg:w-[180px] self-end text-right whitespace-pre-line">{"A filmmaker, photographer, and engineer from Markham, Ontario. I spend my time telling stories, shooting videos, and daydreaming about my next trip. Currently doing a 9 to 5 at Tesla. "}</p>
